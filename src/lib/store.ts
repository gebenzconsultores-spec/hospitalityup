...
export type ViewMode = 'dashboard' | 'empleados' | 'ventas' | 'capacitacion' | 'bolsa' | 'configuracion' | 'trabajador' | 'servicios' | 'propiedades' | 'nps-survey' | 'clima' | 'empresas-accesos' | 'empresas-grupos' | 'proveedores'
...
export const useAppStore = create<AppState>()(
  persist(
    ...
    {
      name: 'hospitalityup-store',
      partialize: (state) => ({
        userRole: state.userRole,
        userName: state.userName,
        userPropiedadId: state.userPropiedadId,
        userPropiedadNombre: state.userPropiedadNombre,
        userEmpleadoId: state.userEmpleadoId,
        userEmpleadoCodigo: state.userEmpleadoCodigo,
